...
def check_stability(obj_detector, cluster_id):
    ...
    if obj_detector.get_objects()[cluster_id].color == b'd':
         return True
...
def check_adjacency(obj_detector, cluster_1, cluster_2):
    # Given obj_detector and the cluster IDs to compare, returns whether the objects are adjacent

    object_1_coordinates = obj_detector.get_objects()[cluster_1].coordinates
    object_2_coordinates = obj_detector.get_objects()[cluster_2].coordinates
